...
<body class="font-[Inter] bg-white text-gray-800">
  ...
  <header class="flex items-center justify-between px-6 py-4 shadow-md bg-white">
    <div class="flex items-center gap-3">
      <img src="https://tamanzakat.org/wp-content/uploads/2022/05/TAZA-700x394.png" alt="Logo" class="h-10 w-auto">
    </div>
    <nav class="flex gap-6 font-medium">
      <a href="#program" class="hover:text-green-600">Program Unggulan</a>
      <a href="#daftar" class="hover:text-green-600">Daftar</a>
      <a href="#sosmed" class="hover:text-green-600">Media Sosial</a>
    </nav>
  </header>
        ...
        <div class="w-full md:w-1/2 flex items-center justify-center px-6 md:px-10 py-10 md:py-0 z-10">
            <div class="max-w-xl">
                <h1 class="text-3xl md:text-5xl font-bold text-gray-900 leading-tight">
                    Berbagi Kebaikan,<br />
                    Wujudkan <span class="text-[#5CA52F]">Harapan</span> Sesama
                </h1>
                <p class="mt-4 text-base md:text-lg text-[#5CA52F] font-medium tracking-wide">
                    #MENGALIRKANKEBAIKAN
                </p>
                <a href="#donasi"
  ...
  <div class="max-w-6xl mx-auto px-4">
    ...
    <div class="flex space-x-6 overflow-x-auto pb-4">
      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden text-left min-w-[300px]">
        ...
        <div class="p-6">
          <h4 class="text-xl font-semibold text-green-600 mb-2">PROGRAM PALESTINA</h4>
      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden text-left min-w-[300px]">
        ...
        <div class="p-6">
          <h4 class="text-xl font-semibold text-green-600 mb-2">TEBAR MANFAAT QURAN</h4>
      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden text-left min-w-[300px]">
        ...
        <div class="p-6">
          <h4 class="text-xl font-semibold text-green-600 mb-2">PROGRAM SEDEKAH SUMUR BOR</h4>
      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden text-left min-w-[300px]">
        ...
        <div class="p-6">
          <h4 class="text-xl font-semibold text-green-600 mb-2">SEDEKAH BERAS RAKYAT</h4>
      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden text-left min-w-[300px]">
        ...
        <div class="p-6">
          <h4 class="text-xl font-semibold text-green-600 mb-2">BEASISWA BINTANG</h4>
      ...
      <div class="bg-white rounded-xl shadow-md overflow-hidden text-left min-w-[300px]">
        ...
        <div class="p-6">
          <h4 class="text-xl font-semibold text-green-600 mb-2">LAYANAN AMBULANCE GRATIS</h4>
...
<!-- Footer -->
<footer class="bg-green-600 text-white py-10 px-6">
